  ...
  <div>
    ...
    <div class="content container">
      <section id="intro" v-if="selected_status == 2">
        ...
        <p>
          针对一系列疑问，我们在京东电商平台，针对23种中性商品抓取的20608条商品信息进行数据分析，试图探寻粉红税的具象踪迹；为进一步倾听民众的想法，我们参与式观察豆瓣小组、抖音评论区，并针对抓取到的1469条帖子，30391条评论进行内容分析与文本分析，再于其中找到渴求发声的人群，倾听与记录他们的声音，以期延伸“粉红税”背后的各种面向。
        </p>
      </section>
    </div>
    <Jumbotron
    ...
    <div class="content container">
      <section id="hear1">
        ...
        <p>
          楚怡正是通过这则视频第一次认识到“粉红税”。看完视频并愤然转发给好友后，还没来得及缓和心情，她旋即发现自己也深受其害——当她在购物平台上查询自己近期的消费记录，发现自己在过去一年内陆陆续续踩雷了视频里提到的商品：化妆镜、洗发水，甚至连自己购买的笔筒，搜索同款产品时都能发现更大众的款式，价格更为低廉。而当楚怡在宿舍群与舍友们讨论起此事，她们先是统一了口径，对此深感气愤。“我们各自去搜索了视频里提到的一些商品，有些商品的男女款价格差真的离谱到令人发指。”更大的问题也随之而来，一番讨论之下，楚怡在群里留下一串疑问：“为什么在此之前，我们都意识不到这件事情？”
        </p>
        <p>
          这个问题引起了女孩们的思考，也折射出这个议题长期以来的国内受众群体中的认知处境。群聊界面静置良久，楚怡意识到问题所在——<b
            >这种“后知后觉的被欺骗感”或许来自相关议题的缺失。</b
          >
        </p>
        <p>
    ...
    <div class="content container">
      <section id="hear2">
        <p>
          问题在于，绝大多数的相关微博话题词条中，讨论数量不超过5000，最高的一条#女款总是比男款贵是粉红税吗#讨论量仅达到1w+，与动辄上百万讨论量的社会议题相比，这或许并不在“广泛讨论”的范畴。<b
        ...
        <p>
          在纽约消费者事务部的这项研究报告中，调查商品被大致划分成个人护理、保健品、童装、玩具配件、成人服装五大类，这五类商品的取样前提均为男女两款产品的功能属性与制作成本均无明显差异。在此基础上，事务部通过对市场样本的广泛调研，最终发现在上述五大商品类目中，均出现4%-13%不等的性别溢价，且均为女性商品高于男性商品。而这项报告，引起了美国民众的广泛关注，也让学界就此议题进行一轮又一轮的研讨与交锋。
        </p>
        <p>
        ...
        <p>
          但即便声音微弱，我们同样发现了一些潜在的讨论踪迹。创建于2020年11月24日的豆瓣讨论组"粉红税抵制者联盟”中汇聚了26298名讨论小组的组员，我们抓取其中1335条帖子中包含的30391条评论，发现高频话题仍然是豆瓣网友对“粉红税重灾区”的讨论。
        </p>
        <!-- 豆瓣讨论区提及商品 -->
        <b-container>
          <div
        ...
        <p>
          在讨论帖中，豆瓣网友“集火”的粉红税灾区覆盖极广：服饰、洗护用品、美妆用品、玩具、数码产品......这些在生活中数见不鲜的产品，在评论区中均被描述成承载“粉红税”的罪恶容器。而在豆瓣网友的讨论中，似乎粉红税已经完全蔓延到生活中的方方面面，成为大众消费中隐性但顽固的一部分。我们可以看见，在834次涉及到粉红税商品重灾区的讨论中，关于服装类产品的讨论高达416次，占据接近一半的讨论度。而服装作为大众普遍的刚需消费品，产品的价值浮动与差异对消费者的影响是整体且广泛的。
        </p>
        <p>
          尽管2万多名网友的讨论在14+亿网民的庞大基数面前仍如沧海一粟，但这种“圈地自萌”的集体发声似乎为“粉红税”的讨论争取了话语空间。而停留在一个个字节之间的倾诉仍然显得孱弱，围绕“粉红税”是否有更多立体鲜活的故事？孤立的个体讲述能否串联起更广泛意义的发现？
        </p>
      </section>
    </div>
    ...
    <div class="content container">
      <section id="lifejourney1">
        ...
        <p>
          同样的，ID为「注销已」的豆瓣用户在社交媒体上分享个人购物经历，得知安踏旗舰店上某款的运动鞋，女性尺码也要比男性尺码贵20元，随后向客服询问价格差异的缘由，然而只得到“优惠力度不同”的答复。诸如“颜色不同”、“不同商品的优惠套餐不同”，是电商平台客服们的常见话术。面对此类现象，当下女性消费者的维权似乎止步于社交媒体上的控诉，或是选择“绕道而行”。
        </p>

        <p>
          诚然，供需关系或消费弹性会对男性和女性产品价格造成影响，进而产生差距，但“粉红定价”表象背后指向一种基于性别的定价歧视问题。“我并不认为这是一种合理的现象”，当听闻这个事例，楚怡耷拉着肩膀无奈地说。“我觉得这件事情很无奈，因为我们都没办法确认这是否是一件普遍的事情。换言之，如果只是很局部的小事，为什么会有人愿意参与？”楚怡坦诚地表达了她的困惑，留下一声叹息。
        </p>
        <p>
          但我们发现，这并非如楚怡所言的“局部小事”，在20608条商品信息中，我们发现这件事出现了更为严肃的走向。据京东电商平台上抓取的不同商品价格数据反映，从儿童玩具、成人服饰到老年用品，女用商品通常要比男用商品均价要高，且这些商品往往在核心功能上并无差异。此类溢价现象通常表现为，同一品牌同一设计下，粉色商品要比其他颜色的商品贵。甚至有时仅仅将商品名称条目中的“女”，更改成“男”，就产生了不可忽视的价格差。
        </p>
      </section>
      <!-- 女性一生换装 -->
      <div class="container">
      ...
      <section id="lifejourney2">
        ...
        <p>
          从童装价格数据开始，童装（男）的均价为139.72元，而童装（女）的均价数据为171.88元，二者价格相差超过30元。而众所周知，由于婴儿与幼童阶段，男女体格差异还不显著，服装尺码与所需布料都较为接近，二者单价差异如此之大，可以窥见问题所在。而在童装之外，许多日常用品也或多或少存在粉红税：学生时代的文具、成年以后的成人服饰、步入职场后的化妆用品、日常中必不可少的洗发水、甚至是年老后服用的钙片、老年奶粉等保健品......这些商品中均出现了显著的男女定价差异，暴露了问题所在——<b
            >“粉红税”陷阱并不局限于某个消费领域的一隅，令人担忧的是，它足以贯穿女性成长的一生。</b
          >
        </p>
        <p>
          无奈的是，大众对“粉红税”的认知更像是"洞穴以内”的人，身陷迷局而不自知。对于绝大多数消费者而言，他们并不如豆瓣讨论小组以内的网友一般，对粉红税深恶痛绝。尽管女性在经济上要比男性付出更大代价，她们在多数情况下不会采取进一步的维权行为，愤怒的情绪终究会被平息。而作为曾经的“受害者”雨婷表示，将来如果在该店遇到了喜欢的商品，即使百般纠结，最终她的选择仍然是——<b
            >“我还是会买的”。</b
          >
        </p>
        <p>
          甚至有人认为部分商品的溢价是合理存在的。"其实对于女性而言，她们对产品要求更苛刻，产品成本应该也会相应提升吧，那么价格不一样也很正常。”职场白领凌志如是说。但当凌志被问及到如何看待因布洛芬的封面而导致的定价差异问题，凌志无言以对，旋即表示：“那可能还是商家的别有用心”这番话似乎有一定的道理，在豆瓣评论区除了有关于“重灾区”的讨论，女孩们同样关心粉红税从何而来。豆瓣网友@Purple
    ...
    <div class="content container">
      <section id="deepin">
        ...
        <p>
          对粉红色、精致香味、精美包装有着极致的偏爱，这是消费主义时代下，女性消费者被塑造出来的常见刻板印象。当部分针对女性设计的商品被添加了特殊香料或其他成分时，更高的设计制造成本致使售价更高，这无可厚非。“如果商品是在真正意义上为女性定制更好的服务，有质的飞跃，那我会愿意为此买单”，楚怡提到。
        </p>
        <p>
          然而，在核心功能不变的情况下，粉色产品的定价比同款商品的其他颜色定价更高的现象也并不罕见。在这种情景下，消费者其实会倾向于做出理性的选择。在得知产品几乎别无二致的情况下，商品价格产生的差异会让消费者恍然大悟，并随即"望而生畏"。
        </p>
        <p>
          在我们设计的问卷中，我们提供了四种商品消费场景：布洛芬、键盘、雨伞、行李箱，正如报道开篇展示的布洛芬消费选择实验，我们对其他三样产品也进行了类似的设计部署。我们先让消费者针对不同的色系，做出第一反应下的选择。随后，在公布“粉红税”陷阱之后，让消费者再次做出选择，结果自然明朗——消费者在直观的数据对比下，做出了更为理性的选择。
        </p>
        ...
        <p>
          但上述选择成立的前提在于：消费者获悉充分的商品信息。在消费者还身陷困局，缺乏足够的时间精力"货比三家"但上述选择成立的前提在于：消费者获悉充分的商品信息。在消费者还身陷困局，缺乏足够的时间精力"货比三家"的时候，商家已经想出了更精当的伎俩。相比单纯更换商品颜色，外包装整体的更新换代，似乎为商品提价赋予了更“正当”的提价契机。正如报道开头的互动案例，以“芬必得”布洛芬咀嚼片为例，作为一种较为大众的止痛片，该药品的外包装盒从先前的男性人像变成女性人像，疼痛点从先前的头部转移至女子腹部位置，货架上的名称也从过往的“普通款”更改为“痛经专用款”。
        </p>
        <p>
          据佛山市某药店店主梁先生透露，新老两款布洛芬咀嚼片在成分、功效上无异，二者的重要成分布洛芬含量均为0.2克/粒。然而，在同一容量前提下，各大电商平台上标示的价格却相距甚远——新款价格却在老款基础上翻了一倍。
        </p>
        ...
        <p>
          豆瓣网友@Purple
          Rain在她的另一篇帖子中写道：”有时候，正是观念把我们束缚了，凭什么女性就一定得是消费的主力军，这并不是自然形成的。“而楚怡也同样提到，”我们在宿舍群讨论时也提到这个问题，最后我们一致同意，这是对女性的歧视。”由此可见，粉红税或许是一个深远的文化议题。除了上述的两人，论坛中深受“粉红税”困扰的消费者，也时常会习惯性把将问题的矛头指向“性别歧视”与社会文化。这样的担忧不无道理。
        </p>
        <p>
          ...
          “无论是穿着绫罗绸缎的上层贵妇，还是穿着普通的中产阶级妇女，或是没戴帽子的姑娘们，她们在挑选蕾丝、皮草、裙子、贴身内衣等物品时激动得面色绯红，像见到情人一样。”,
          女性的购买欲与情欲联系在一起,女性的消费潜力也在无形中被放大。
        </p>
        <p>
        ...
        <p>
          这并非是平地一声雷，美国在消除粉红税的道路上已探索已久。早在20世纪30年代，美国在起草消费税体系时就已提出了粉红税的概念；而于1995年，加利福尼亚州通过了《性别税废除法案》，在全国有关禁止性别歧视性定价的法案探索中迈出里程碑式的第一步。而回首我国国内现有法律法规，类似规范尚属空白地带。
        </p>
        ...
        <p>
          现如今，美国少数州和地方立法机构已经针对基于性别的服务定价采取了相关打击措施，但有关取缔粉红税的法律探索仍然道阻且长。一方面，尽管存在上述出台法律的支持，但因同类商品存在价格差异而与商家对簿公堂的消费者依然少之又少。从法律数据库Westlaw检索结果来看，有关性别歧视性定价的案件总计仅有6例，而除去同一案件的上诉审理，只有3位消费者就商品性别定价问题向法院提出诉讼，并皆以败诉告终。
        </p>
        ...
        <p>
          “男性和女性能购买面向异性销售的产品，但由于社会条件和社会对于两性期望的不同，使得女性在消费的选择上更加不公平。”2020年7月，舒尔特以克诺普科公司的除汗剂具有性别歧视性的定价方案为由，向法院起诉克诺普科公司。但由于舒尔特所依据的法规并没有涉及商品定价，其本人也没有办法就这些不同产品线的生产、研发和营销相关的成本提出任何事实指控，导致该案件最终以其败诉收场。在该判决书中，法官留下了他的主张：“通常，我们期望市场能够自我纠正，并依靠消费者自主购买的行为来管理市场。消费者可以选择最理想的替代品以避免那些不满意的商品。”司法将商品定价交由自由市场调节，保障女性消费者的合法权益仍任重道远。
        </p>
        <p>
    ...
    <div class="content container">
      <section id="end">
        ...
        <p>
          当然，进一寸亦有欢喜。近年来，性别中立的营销方式越来越得到认可，从产品设计、开发、生产到推广，各个环节都更注重打破传统性别叙事，提倡给予女性更多自主选择权、倡导女性审美多元化。而2021年1月15日推出的《深圳市广告性别平等审视指南》也同样释放了关注两性定价平等的积极信号，成为制度探索路上踏出的勇敢一步。
        </p>
        <p>
          “我们要一起向上，共同对抗。”这是停留楚怡微信界面中，关于这场“粉红税”讨论的最后一句。但破除“粉红税”的道路究竟有多漫长，只有当更多人亲身踏上征途方能体会。
        </p>
      </section>
    </div>
    <div class="">
