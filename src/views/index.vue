  ...
  <div>
            ...
            <b-col>
              <div class="content container">
                <section id="HCI_result">
                  ...
                  <p>
                    针对一系列疑问，我们在京东电商平台，针对23种中性商品抓取的20608条商品信息进行数据分析，试图探寻“粉红税”的具象踪迹；为进一步倾听民众的想法，我们参与式观察豆瓣小组、抖音评论区，并针对抓取到的1469条帖子进行内容分析与文本分析，再于其中找到希望发声的人群，倾听与记录他们的声音，以期延伸“粉红税”背后的各种现象。
                  </p>
                </section>
              </div>
            </b-col>
    ...
    <div class="content container">
      <section id="hear1">
        ...
        <p>
          这个问题引起了女孩们的思考，也折射出这个议题长期以来在国内受众群体中的认知处境。群聊界面静置良久，楚怡意识到问题所在——“这种后知后觉的被欺骗感，或许来自相关议题的缺失。”
        </p>
        <p>
    ...
    <div class="content container">
      <section id="lifejourney1">
        ...
        <div style="max-width: 900px">
          <b-img :src="require('@/assets/product_cmp.jpeg')" fluid></b-img>
        ...
        <p>
          在20608条商品信息中，我们发现这件事出现了更为严肃的走向。获取自京东电商平台的不同商品价格数据显示，从儿童玩具、成人服饰到老年用品，女用商品通常要比男用商品均价要高，且这些商品往往在核心功能上并无差异。
        </p>
    ...
    <div class="content container">
      <section id="deepin">
        ...
        <p>
          ...
          >
          ”2020年7月，舒尔特（Schulte）以克诺普科（Conopco）公司的除汗剂具有性别歧视性的定价方案为由，向法院起诉克诺普科公司。
        </p>
        <p>
    ...
    <div class="content container">
      <section id="end">
        ...
        <p>
          况且，“粉红税”在不同的学界讨论情景中有不同的定义，我们的报道中只局限于其中较为广泛运用的定义，却无法进一步触及这个议题中的模糊地带：附着商业营销色彩的樱花限定女性酒定价远高于同款经典鸡尾酒，算不算粉红税？天然为女性设计的卫生棉条，又是否指向不合理溢价……这些问题仍然有待讨论。
        </p>
        <p>
          当然，进一寸亦有欢喜。近年来，
          <b style="color: #ed256d"
