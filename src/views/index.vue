  ...
  <div>
    ...
    <div class="content container">
      <section id="intro" v-if="selected_status == 2">
        ...
        <p>
          针对一系列疑问，我们在京东电商平台，针对23种中性商品抓取的20608条商品信息进行数据分析，试图探寻粉红税的具象踪迹；为进一步倾听民众的想法，我们参与式观察豆瓣小组、抖音评论区，并针对抓取到的1469条帖子，30391条评论进行内容分析与文本分析，再于其中找到渴求发声的人群，倾听与记录他们的声音，以期延伸“粉红税”背后的各种现象。
        </p>
      </section>
    </div>
    <Jumbotron
    ...
    <div class="content container">
      <section id="deepin">
        ...
        <p>
          但上述选择成立的前提在于：消费者获悉充分的商品信息。在消费者还身陷困局，缺乏足够的时间精力“货比三家”的时候，商家已经想出了更精当的伎俩。相比单纯更换商品颜色，外包装整体的更新换代，似乎为商品提价赋予了更“正当”的提价契机。正如报道开头的互动案例，以“芬必得”布洛芬咀嚼片为例，作为一种较为大众的止痛片，该药品的外包装盒从先前的男性人像变成女性人像，疼痛点从先前的头部转移至女子腹部位置，货架上的名称也从过往的“普通款”更改为“痛经专用款”。
        </p>
        <p>
